...
export default function General() {
  ...
  const item2 = "Rules of conduct apply to all students from the time they leave home for school/college and till \nthey have returned home."
  const item3 = 'Mischief or Indiscipline of any kind, overt display of affection, theft and borrowing without \npermission of the owner and improper handling of the property of others, and damaging the property of the \nInstitution is punishable.'
