...
export default function FeeShedule() {
  ...
  const item3 = 'Admission fees to be paid only by new entrants and students promoted from Sr. Kg. to Std. I and \nStd IV to Std V'
  ...
  const i1 = 'Fees can be paid in school (cash , Cheque) or in the bank by online mode(Gpay).'
  const i2 = 'All fees of the Pre-Primary section to be paid in the school office during the office hours.'
