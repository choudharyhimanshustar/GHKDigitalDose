...
export default function Withdrawl() {
  ...
  const item2 = "Students must not be seen in the corridor when classes are in session."
  const item3 = 'Students must use the Library facility and maintain silence in the reading Hall.'
  ...
  const item6 = 'Students must not indulge in any form of ragging. Any student found ragging or involved in any \nsuch activity will be punished as per the provisions of Law.'
  const item7 = 'Students should not cause any damage to the college property, failing which he / she will be \nfined.'
  const item8 = 'Students should not invite outsiders or friends from other colleges to the premises.'
  const item9 = 'Students with poor attendance or poor academic performance may not be permitted to \ncontinue in the college. Regular attendance is the only criteria for continuation in the college.'
  const item10 = 'Use of filthy language is strictly prohibited in the college premises.'
