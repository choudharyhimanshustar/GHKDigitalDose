...
export default function RuleConduct() {
  ...
  const item2 =
    "Students should bring the school handbook, required text books, notebooks, notepads and other \nschool related material every day.";
  const item3 =
    "Books and other belongings should be neatly labeled with the Name, Standard, Division and Roll \nNo. of the student.";
