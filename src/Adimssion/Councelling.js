...
export default function Councelling() {
    ...
    const item2 = "Specialized inclusive support for children with \n special needs / learning disability is taken into \n consideration."
    const item3 = 'The school endeavours towards holistic \n development and ensures the all round \n development of the child'
    ...
    return (
        <div>
            <div className='councellingmainimg'>
                <div className='Cimginnertext'>
                    <h1>ADMISSION <br /> COUNCELLING</h1>
                </div>
            </div>
