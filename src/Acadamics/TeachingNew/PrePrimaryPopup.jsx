...
function PrePrimaryPopup({ visible, onClose }) {
  ...
  return (
    <div
      ...
      className="mx-80 fixed inset-0 bg-opacity-30 flex justify-center items-center aboutpopup sm:mx-20 "
    >
    ...
    margin: "30px 50px 0px 50px"}}>
        ...
        <br />
        <br />
        <p className="text-lg text-gray leading-7 px-34 sm:px-10 aboutcontent h-[50vh] overflow-y-scroll">
