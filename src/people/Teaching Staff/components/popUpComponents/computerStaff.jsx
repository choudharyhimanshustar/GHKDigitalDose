...
const computerStaffPopUp = ({ status }) => {
  return (
    <div style={style.parent}>
      <div style={style.popUpContainer} className="popUpContainer">
        <div style={style.popUpBackground} className="popUp">
          ...
          <div style={style.popUpHeader}>COMPUTER STAFF</div>
          <div className="tableContainer" style={style.tableContainer}>
            <table style={style.table}>
              ...
              <tr>
                ...
                <td style={style.tableSecondColumn}>Rahila Uday</td>
                <td style={style.tableThirdColumn}>M.S.C</td>
              </tr>
              <tr>
                <td
                  style={{
...
export default computerStaffPopUp;
